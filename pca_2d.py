...
pca_df['t-SNE First Dimension'] = pca_test_data[:,0]
pca_df['t-SNE Second Dimension'] = pca_test_data[:,1]
plt.figure(figsize=(16,10))
plt.scatter(pca_test_data[:,0], pca_test_data[:,1], c = test_label, s = 0.5)
